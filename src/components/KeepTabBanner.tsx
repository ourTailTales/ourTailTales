...
export function KeepTabBanner({ active }: { active: boolean }) {
  ...
  return (
    <div className="sticky top-0 z-40 border-b border-tail/25 bg-tail-wash/95 backdrop-blur">
      <p className="mx-auto flex max-w-5xl items-center gap-2 px-5 py-2.5 text-sm text-tail-deep">
